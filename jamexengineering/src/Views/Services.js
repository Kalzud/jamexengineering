/** Author: @Emmanuel O. Uduma
 This page contains the code for the service section of the website
this shows all the services offered.**/
...
const Services = () =>{
        return(
            <>
                <div className='row servicePage'>
                    <div className='col-sm-12'>
                        <div className='row serviceTop'>
                            <div className='card top'>
                                <div className='card insideTop' style={{border:"none"}}>
